        ...
        <div class="main-content-wrapper">
            <div class="main-content" id="mainContent">
                ...
                <div class="section-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.hero.update', $heroSection) }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">
                                            @if ($heroSection->image1)
                                                <img src="{{ asset($heroSection->image1) }}" alt="Current Image 1"
                                                    style="max-width: 100px; max-height: 100px; object-fit: cover; margin-bottom: 5px;">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">
                                            @if ($heroSection->image2)
                                                <img src="{{ asset($heroSection->image2) }}" alt="Current Image 2"
                                                    style="max-width: 100px; max-height: 100px; object-fit: cover; margin-bottom: 5px;">
                                                <br>Leave empty to keep current image
                                            @else
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">
                                            @if ($heroSection->image3)
                                                <img src="{{ asset($heroSection->image3) }}" alt="Current Image 3"
                                                    style="max-width: 100px; max-height: 100px; object-fit: cover; margin-bottom: 5px;">
                                                <br>Leave empty to keep current image
                                            @else
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">
                                            @if ($heroSection->image4)
                                                <img src="{{ asset($heroSection->image4) }}" alt="Current Image 4"
                                                    style="max-width: 100px; max-height: 100px; object-fit: cover; margin-bottom: 5px;">
                                                <br>Leave empty to keep current image
                                            @else
