        ...
        <!-- Create How It Works Item -->
            <div class="section-card">
                <div class="card-header">
                    <i class="fas fa-plus me-2"></i>Create New How It Works Item
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.howitworks.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control" value="{{ old('title') }}" placeholder="Enter the step title" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="order" id="order" class="form-control" required>
                                        ...
                                        @for($i = 1; $i <= 4; $i++)
                                            @php
                                                $isTaken = \App\Models\HowItWork::where('order', $i)->exists();
                                            @endphp
                                            <option value="{{ $i }}" {{ old('order') == $i ? 'selected' : '' }} {{ $isTaken ? 'disabled' : '' }}>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-custom">
                                        <i class="fas fa-save me-2"></i>Create How It Works Item
                                    </button>
