                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control form-control-lg" value="{{ old('title', $plan->title) }}" placeholder="Enter plan title (e.g., Basic Plan, Premium Plan)" required>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="price" id="price" class="form-control form-control-lg" value="{{ old('price', $plan->price) }}" placeholder="0.00" step="0.01" min="0" required>
                                        </div>
                                    ...
                                    @foreach($plan->features as $index => $feature)
                                        <div class="feature-item mb-3">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="features[]" class="form-control" placeholder="Enter a plan feature" value="{{ old('features.' . $index, $feature->feature) }}">
                                                <button type="button" class="btn btn-outline-danger remove-feature" {{ $plan->features->count() <= 1 ? 'style="display: none;"' : '' }}>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <br>
                                                <small class="text-muted">Last updated: {{ $plan->updated_at->format('M d, Y \a\t h:i A') }}</small>
                                            </div>
