                        ...
                        <form action="{{ route('admin.plans.update', $plan) }}" method="POST">
                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-3">
                                            <label for="title" class="form-label fw-bold">
                                                <i class="fas fa-tag me-2 text-primary"></i>Plan Title <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <input type="text" name="title" id="title"
                                                class="form-control form-control-lg"
                                                value="{{ old('title', $plan->title) }}"
                                                placeholder="Enter plan title (e.g., Basic Plan, Premium Plan)" required>
                                            <div class="form-text">This will be displayed as the main heading for this plan
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label for="price" class="form-label fw-bold">
                                                <i class="fas fa-dollar-sign me-2 text-success"></i>Price (AED) <span
                                                    class="text-danger">*</span>
                                            </label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" id="" class="form-control" rows="4" required>{{ old('description', $plan->description) }}</textarea>
                                            <div class="form-text">Provide a detailed description of what this plan offers
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <strong>Features:</strong> Add the key features and benefits included in this plan. You
                                    can add as many features as needed.
                                </div>
                                            ...
                                            <div class="feature-item mb-3">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="features[]" class="form-control"
                                                        placeholder="Enter a plan feature"
                                                        value="{{ old('features.' . $index, $feature->feature) }}">
                                                    <button type="button" class="btn btn-outline-danger remove-feature"
                                                        {{ $plan->features->count() <= 1 ? 'style="display: none;"' : '' }}>
                                    ...
                                    @else
                                        <div class="feature-item mb-3">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="features[]" class="form-control"
                                                    placeholder="Enter a plan feature (e.g., 5 Services per month)"
                                            ...
                                            <div class="card-body">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label for="is_active" class="form-check-label fw-bold">
                                                        <span class="badge bg-success me-2">Active</span> Make this plan
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    ...
                                                    <strong>Ready to update this subscription plan?</strong>
                                                    <br>
                                                    <small class="text-muted">Last updated:
                                                        {{ $plan->updated_at->format('M d, Y \a\t h:i A') }}</small>
                                                </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            let featureCount = {{ $plan->features->count() ?: 1 }};
        ...
        `;
            ...
            $('form').on('submit', function(e) {
                ...
                submitBtn.html('<i class="fas fa-spinner fa-spin me-2"></i>Updating...').prop('disabled',
                    true);
