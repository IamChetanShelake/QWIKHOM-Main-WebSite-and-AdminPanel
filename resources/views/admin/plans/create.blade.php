                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" id="" class="form-control" rows="4" required>{{ old('description') }}</textarea>
    ...
    <script>
        ...
        `;
            ...
            $('form').on('submit', function(e) {
                ...
                submitBtn.html('<i class="fas fa-spinner fa-spin me-2"></i>Creating...').prop('disabled',
                    true);
