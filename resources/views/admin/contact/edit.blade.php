                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <textarea name="location" id="location" class="form-control form-control-lg" rows="4" placeholder="Enter the business address or location" required>{{ old('location', $contact->location) }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="tel" name="phone" id="phone" class="form-control form-control-lg" value="{{ old('phone', $contact->phone) }}" placeholder="+1 (555) 123-4567" required>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control form-control-lg" value="{{ old('email', $contact->email) }}" placeholder="info@yourcompany.com" required>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <strong>Ready to update this contact information?</strong>
                                                <br>
                                                <small class="text-muted">Last updated: {{ $contact->updated_at->format('M d, Y \a\t h:i A') }}</small>
                                            </div>
                                            <div class="d-flex gap-2">
                                                <button type="submit" class="btn btn-success btn-lg">
                                                    <i class="fas fa-sync me-2"></i>Update Contact Info
                                                </button>
