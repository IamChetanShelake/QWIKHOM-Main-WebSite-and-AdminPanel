                    ...
                    <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control form-control-lg" value="{{ old('title') }}" placeholder="Enter the service name" required>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="description" class="form-control" rows="6" placeholder="Describe what this service offers, its benefits, and what customers can expect..." required>{{ old('description') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="alert alert-info">
                                ...
                                <strong>Tip:</strong> Upload a high-quality image that represents this service. Recommended size: 600x400px or larger.
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card border-success">
                                        <div class="card-body text-center">
                                            ...
                                            <div class="form-text">Upload an image that represents this service</div>
                                            <div id="preview" class="mt-2 d-none">
                                                <img id="img-preview" class="img-fluid rounded" style="max-height: 200px;" alt="Preview">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                <strong>Ready to add this service?</strong>
                                            </div>
