        ...
        <!-- Create About Section -->
            <div class="section-card">
                <div class="card-header">
                    <i class="fas fa-plus me-2"></i>Create New About Section
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.about.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" id="title" class="form-control form-control-lg" value="{{ old('title') }}" placeholder="Enter the main title for this about section" required>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="description" class="form-control" rows="4" placeholder="Describe your company, mission, or what makes you unique..." required>{{ old('description') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="alert alert-info">
                                ...
                                <strong>Tip:</strong> Upload high-quality images that represent your brand and services. Recommended size: 800x600px or larger.
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card border-primary">
                                        <div class="card-body text-center">
                                            ...
                                            <div id="preview1" class="mt-2 d-none">
                                                <img id="img-preview1" class="img-fluid rounded" style="max-height: 150px;" alt="Preview">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card border-success">
                                        <div class="card-body text-center">
                                            ...
                                            <div id="preview2" class="mt-2 d-none">
                                                <img id="img-preview2" class="img-fluid rounded" style="max-height: 150px;" alt="Preview">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="help_phone" id="help_phone" class="form-control" value="{{ old('help_phone') }}" placeholder="+1 (555) 123-4567">
                            ...
                            <div class="card border-danger">
                                <div class="card-header bg-light">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="mb-0">
                                            <i class="fas fa-plus-circle me-2 text-danger"></i>Manage Key Points
                                        </h6>
                                ...
                                <div class="card-body">
                                    <div id="key-points-container">
                                        <!-- Key points will be added here dynamically -->
                                    </div>
